								...
								<div class="feat_property">
									<div class="thumb">
										...
										<div class="thmb_cntnt">
											...
											<span class="fp_price">$2,500<small>/mo</small></span>
										</div>
									</div>
									<div class="details">
										<div class="tc_content">
											<p class="text-thm">Apartment</p>
											<h4>Luxury Apartment with City View</h4>
											<p><span class="flaticon-placeholder"></span>456 Elm St Apt 12</p>
											<ul class="prop_details mb0">
												<li class="list-inline-item"><span>Beds: 2</span></li>
												<li class="list-inline-item"><span>Baths: 1</span></li>
												<li class="list-inline-item"><span>Sq Ft: 900</span></li>
											</ul>
										</div>
										<div class="fp_footer">
											<ul class="fp_meta float-left mb0">
												<li class="list-inline-item"><span href="#"><img src="images/property/pposter1.png" alt="pposter1.png"></span></li>
												<li class="list-inline-item"><span href="#">Alex</span></li>
											</ul>
